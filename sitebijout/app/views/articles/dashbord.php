...
<h1 class="text-center  my-5 py-3">View All Products </h1>
 <div class="heading_container  d-flex justify-content-between">
            <a href="<?php echo URLROOT; ?> /articles/add" class="btn btn-black " style=" font-size: 1em;"><i class="ri-pencil-line">Add Article</i></a>
        ...
        <div class="col-10 mx-auto p-4 border mb-5">
            ...
            <table class="table">
                ...
                <?php foreach ($data['articles'] as $article) : ?>
                        <tr>
                            <td><?php echo $article->id_prod; ?></td>
                            <td> <?php echo $article->name_prod; ?></td>
                            <td><?php echo $article->prix; ?> <b class="float-right"> $ </b></td>
                            <td><?php echo $article->quantite; ?></td>
                            <td>
                            <a href="<?php echo URLROOT; ?>/articles/edit/<?php echo $article->id_prod; ?>" class="btn btn-warning" >Edit</a>
                     
                            </td>
                            <td>
                            <a href="<?php echo URLROOT; ?>/articles/delete/<?php echo $article->id_prod; ?>" class="btn btn-danger" >Delete</a>
