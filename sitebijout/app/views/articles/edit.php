...
<div class="container col-md-8">
        ...
        <div class="container-fluid my-5">
            <div class="row p-2">
                <div class="col-md-12">
                    <form action="<?php echo URLROOT;?>/Articles/edit/<?php echo $data['id_prod']?>" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" id="exampleFormControlInput1" value="<?php echo $data['name_prod']; ?>" >
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" name="prix" class="form-control" id="exampleFormControlInput1" value="<?php echo $data['prix']; ?>" >
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" name="quantite" class="form-control" id="exampleFormControlInput1"value="<?php echo $data['quantite']; ?>" >
                        </div>


                        <div class="col-12 d-flex justify-content-between">
                        <button type="submit" class="btn btn-lg btn-block">Edit</button>
